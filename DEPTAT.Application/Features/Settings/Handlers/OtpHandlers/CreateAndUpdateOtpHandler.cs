            ...
            try
            {
                ...
                if (exit)
                {
                    ...
                    if (save)
                    {
                        ...
                        SMSGateway.Send($"Use OTP: {otp.OtpCode} Code for this year's exams.", getStudentNumber?.PhoneNumber);
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    if (save)
                    {
                        response.IsSuccess = true;
                        response.Message = "OTP CLOCKED";
                        SMSGateway.Send($"Use OTP: ${otpEntity.OtpCode} Code for this year's exams.", getStudentNumber?.PhoneNumber);
                    }
                    else
                    {
                        response.Message = "OTP FAILED TO CLOCK";
