...
{
    public class GetTotalOTPQueryHandler : IRequestHandler<GetTotalOTPQuery, int>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;

        public GetTotalOTPQueryHandler(IUnitOfWork unitOfWork, IMapper mapper)
        {
            _unitOfWork = unitOfWork;
            _mapper = mapper;
        }

        public async Task<int> Handle(GetTotalOTPQuery request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                {
                    var otpList = await _unitOfWork.OtpRepository.GetAll();
